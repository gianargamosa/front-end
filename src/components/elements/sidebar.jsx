...
import SidebarUserName from './sidebar-username';
import SearchForm from './search-form';
import RecentGroups from './recent-groups';

debugger;
const Sidebar = ({ user, signOut }) => (
  <div className="col-md-4 sidebar" onClick={toggleSidebar}>
    <div className="media">
        <div className="media-left">
            <Link to={`/${user.username}`} >
              <img src={user.profilePictureMediumUrl} className="media-object img-rounded" width="49" height="49"/>
            </Link>
        </div>
        <div className="media-body">
            <h3 className="media-heading sidebar-profile">
                <SidebarUserName user={user} display={user.screenName}/>
            </h3>
        </div>
    </div>
    <div className="panel-default ads">
      <h5>Welcome To Twitter</h5>
      <p>Sign-up to get your own personalized timeline</p>
      <button className="btn btn-md btn-block ads-button">Invite Someone?</button>
    </div>
    <ul className="list-group sidebar-nav">
        ...
        <li className="list-group-item">
            <a href="/filter/discussions"><b>@mentions</b></a>
        </li>
        <li className="list-group-item">
            <a href="#">Favorites</a>
        </li>
