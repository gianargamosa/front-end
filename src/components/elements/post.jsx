...
import CountLikes from './likes-count';
...
class Post extends React.Component {
  ...
  render() {
    ...
    const primaryUserpicture = (
      <div className={primaryUserpicClasses}>
        <Link to={`/${props.createdBy.username}`}>
          <img className="media-object primary-picture" src={userpicImage} alt={props.createdBy.username} width="49px" height="49px"/>
        </Link>
      </div>
    );
            ...
            {props.isArchive ? (
              ...
              {props.isInHomeFeed ? (
                <span>
                  ...
                  <UserName className="post-author" user={props.createdBy}/>{' '}&middot;{' '}
              ...
              {props.attachments.length > 0 ? (
                <span>
                  <PostAttachments attachments={props.attachments} isEditing={props.isEditing} removeAttachment={this.removeAttachment}/>
              ...
              {/* <PostComments postId={props.id} postUrl={postUrl} isSinglePost={props.isSinglePost}/> */}
          </div>
        </div>
