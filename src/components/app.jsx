...
import newSidebar from './elements/new-sidebar';
      ...
      <div className={appClasses}>
        ...
        {/* <header className="row">
          <div className="col-xs-8 col-sm-4 col-md-3">
            <h1>
              <IndexLink to="/">Scrumsly</IndexLink>

              {props.isLoading ? (
                <span className="loading"><img src={throbber100} width="30" height="30"/></span>
              ) : (
                <sup className="gamma" title="Gamma">&beta;</sup>
              )}
        ...
        {props.authenticated ? (
          <div>
            <div className="blog-header">
              <div className="col-md-4 logo-column">
                <h2><IndexLink to="/">Scrumsly</IndexLink></h2>
              </div>
              <div className="col-md-8">
                <div className="list-group list-group-horizontal pull-right">
                  <a href="/" className="list-group-item">Home</a>
                  <a href="#" className="list-group-item">Profile</a>
                  <a href="#" className="list-group-item">People</a>
                  <a href="/settings" className="list-group-item">Settings</a>
                  <a href="#" className="list-group-item">Help</a>
                  <a href="#" className="list-group-item">Sign out</a>
                </div>
              </div>
            </div>
            <div className="row show-grid">
              <div className="col-md-12 main-wrapper">
                <div className="row">
                  <div className="col-sm-8 newsfeed">
                    {props.children}
                  </div>
                  <Sidebar/>
                </div>
